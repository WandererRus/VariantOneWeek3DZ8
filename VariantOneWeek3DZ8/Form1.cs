namespace VariantOneWeek3DZ8
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            routes.Add(new Route(2, "15местный", "Ростов", new DateTime(2022, 11, 29), new TimeSpan(9, 30, 0), new DateTime(2022, 11, 29), new TimeSpan(11, 00, 0)));
            ...
            routes.Add(new Route(5, "40местный", "Ростов", new DateTime(2022, 11, 29), new TimeSpan(10, 45, 0), new DateTime(2022, 11, 29), new TimeSpan(12, 15, 0)));
            routes.Add(new Route(6, "15местный", "Ростов", new DateTime(2022, 11, 29), new TimeSpan(11, 15, 0), new DateTime(2022, 11, 29), new TimeSpan(12, 45, 0)));
            routes.Add(new Route(7, "15местный", "Ростов", new DateTime(2022, 11, 29), new TimeSpan(13, 15, 0), new DateTime(2022, 11, 29), new TimeSpan(14, 45, 0)));
            routes.Add(new Route(8, "15местный", "Ростов", new DateTime(2022, 11, 29), new TimeSpan(15, 15, 0), new DateTime(2022, 11, 29), new TimeSpan(16, 45, 0)));
            ...
            routes.Add(new Route(10, "15местный", "Ростов", new DateTime(2022, 11, 30), new TimeSpan(9, 15, 0), new DateTime(2022, 11, 30), new TimeSpan(10, 45, 0)));
            routes.Add(new Route(11, "40местный", "Ростов", new DateTime(2022, 11, 30), new TimeSpan(10, 15, 0), new DateTime(2022, 11, 30), new TimeSpan(11, 45, 0)));
